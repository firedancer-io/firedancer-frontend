...
import UsageBarPoc from "./UsageBarPoc";

export default function PartitionsPoc() {
  ...
  return (
    <Table.Row className={tableStyles.dataRow}>
      ...
      <Table.Cell
        ...
        style={{
          color:
            partition.fragmented_frac >= partition.compaction_trigger_frac &&
            partition.compaction_trigger_frac > 0
              ? "#E5484D"
              : "var(--green-9)",
        }}
      >
