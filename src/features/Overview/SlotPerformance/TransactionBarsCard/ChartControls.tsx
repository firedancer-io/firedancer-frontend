...
import { highlightErrorCode } from "./timelinePlugin";
...
function ErrorControl({ transactions, maxTs }: ToggleGroupControlProps) {
  const errorCodeCount = groupBy(transactions.txn_error_code);
  ...
  return (
    <>
      ...
      >
        <Select.Trigger placeholder="Txn State" style={{ height: "24px" }} />
        <Select.Content>
          <Select.Group>
...
// function IsErrorControl({ transactions }: OldControlProps) {
//   const [isEnabled, setIsEnabled] = useState(false);
//   const uplotAction = useSetAtom(uplotActionAtom);
//   const addError = useSetAtom(addErrorSeriesAtom);
...
//     uplotAction((u, bankIdx) => {
//       checked
//         ? addError(u, transactions, Number(bankIdx))
//         : removeSeries(u, FilterColorEnums.ERROR);
//     });
//   };
