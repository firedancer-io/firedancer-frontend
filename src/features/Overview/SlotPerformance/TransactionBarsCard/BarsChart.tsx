...
import UplotReact, { UplotChartRef } from "../../../../uplotReact/uplot-react";
...
export default function BarsChart({
  ...
  const uplotRef = useRef<UplotChartRef | null>(null);
  ...
  const options = useMemo<uPlot.Options | undefined>(() => {
    ...
    const xOffsetRight = Math.max(containerRight - rechartsRight, 53.5);
  ...
  }, [bankIdx, chartData?.length, isLastChart, setTxnIdx, setTxnState]);
