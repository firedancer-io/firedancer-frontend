...
} as any).lazy(() => import("./routes/slotDetails.lazy").then((d) => d.Route));
const LeaderScheduleRoute = LeaderScheduleRouteImport.update({
  id: "/leaderSchedule",
  path: "/leaderSchedule",
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
  import("./routes/leaderSchedule.lazy").then((d) => d.Route),
);
const GossipRoute = GossipRouteImport.update({
  id: "/gossip",
  path: "/gossip",
  getParentRoute: () => rootRouteImport,
} as any).lazy(() => import("./routes/gossip.lazy").then((d) => d.Route));
